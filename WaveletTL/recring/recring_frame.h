...
#ifndef _WAVELETTL_RECRING_FRAME_H
#define _WAVELETTL_RECRING_FRAME_H
...
//    typedef RecRingFrameIndex<IFRAME> Index;
    
    //! quarklet index class
    typedef RecRingFrameIndex<IntervalFrame> Index;
    ...
    //! default constructor
    RecRingFrame(const IntervalFrame* frame1d, const IntervalFrame* frame1d_11, 
...
//    RecRingFrame(const IntervalFrame& frame1d);
    ...
    typedef struct Support{
      ...
      {
          j[0]=0,j[1]=0,
          xmin[0]=0,xmin[1]=0,xmin[2]=0,xmin[3]=0, xmin[4]=0,xmin[5]=0,xmin[6]=0,xmin[7]=0,
          xmax[0]=0, xmax[1]=0, xmax[2]=0, xmax[3]=0, xmax[4]=0, xmax[5]=0, xmax[6]=0, xmax[7]=0,                 
          ymin[0]=0,ymin[1]=0,ymin[2]=0, ymin[3]=0, ymin[4]=0,ymin[5]=0,ymin[6]=0, ymin[7]=0, 
          ymax[0]=0, ymax[1]=0, ymax[2]=0, ymax[3]=0, ymax[4]=0, ymax[5]=0, ymax[6]=0, ymax[7]=0;
      }
...
//		     InfiniteVector<double, Index>& v) const;
    ...
    */
    ...
    evaluate
    (const typename RecRingFrame<IntervalFrame>::Index& lambda,
    ...
    */
    Array1D<SampledMapping<2> >
    evaluate
    (const InfiniteVector<double, typename RecRingFrame<IntervalFrame>::Index>& coeffs,
     const int resolution) const;
...
#include <recring/recring_frame.cpp>
//#include <recring/recring_evaluate.cpp>
//#include <recring/recring_special.cpp>
//#include <recring/recring_special_matrices.cpp>
