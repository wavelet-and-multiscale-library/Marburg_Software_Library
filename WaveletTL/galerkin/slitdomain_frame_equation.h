...
#ifndef _WAVELETTL_SLITDOMAIN_FRAME_EQUATION_H
#define _WAVELETTL_SLITDOMAIN_FRAME_EQUATION_H
...
namespace WaveletTL
{
  ...
  /*!
    ...
    when reformulating an poisson boundary value problem on the slit domain
    ...
    over the slit domain.
  */
  //template <class IFRAME>
  template <class IFRAME,  class SLITDOMAINFRAME = SlitDomainFrame<IFRAME> >
...
//     : public FullyDiagonalDyadicPreconditioner<typename SlitDomainBasis<IBASIS>::Index>
...
#endif
#ifdef TRIVIAL
    : public TrivialPreconditioner<typename SLITDOMAINFRAME::Index>
#endif
#ifdef ENERGY
  ...
  public:
    ...
    */
    typedef SLITDOMAINFRAME Frame;
//    typedef SlitDomainFrame<IFRAME> Frame;
    /*!
      constructor from a boundary value problem 
      not used anymore
    */
//    SlitDomainFrameEquation(const EllipticBVP<2>* bvp,
//		    const bool precompute_rhs = true);
    
    
    SlitDomainFrameEquation(const EllipticBVP<2>* bvp, const Frame* frame,
		    const bool precompute_rhs = true);
    /*!
    ...
    */
    ...
    /*!
      copy constructor
    */
    SlitDomainFrameEquation(const SlitDomainFrameEquation&);
...
#include <galerkin/slitdomain_frame_equation.cpp>
