...
#ifndef _WAVELETTL_CACHED_QUARKLET_SLITDOMAIN_PROBLEM_H
#define	_WAVELETTL_CACHED_QUARKLET_SLITDOMAIN_PROBLEM_H
...
namespace WaveletTL
{
     ...
     * frame is assumed to be of slitdomain tensor type as modeled by slitdomain_frame.h.
     ...
     *
     * The template class CachedQuarkletSlitDomainProblem implements the minimal signature to be
    ...
    public:
         ...
         * (if zero, CachedQuarkletSlitDomainProblem will compute the estimates)
         */
        CachedQuarkletSlitDomainProblem(PROBLEM* P,
...
#include "cached_quarklet_slitdomain_problem.cpp"

#endif	/* _WAVELETTL__CACHED_QUARKLET_SLITDOMAINPROBLEM_H */
