// implementation for slitdomain_frame_gramian.h
...
//    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::SlitDomainFrameGramian(const EllipticBVP<2>* bvp,
...
//    }
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::SlitDomainFrameGramian(const EllipticBVP<2>* bvp, const Frame* frame,
					    const bool precompute_rhs)
...
//            frame_->set_jpmax(multi_degree(frame_->j0()),0);
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::SlitDomainFrameGramian(const SlitDomainFrameGramian& eq)
...
//            frame_->set_jpmax(multi_degree(frame_->j0()),0);
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    void
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::compute_rhs()
    {
        cout << "SlitDomainFrameGramian(): precompute right-hand side..." << endl;
...
//        cout<<"number of threads: "<<omp_get_num_threads()<<endl;
    ...
    inline
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::D(const Index& lambda) const
    {
...
//        return 1;
    ...
    inline
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::a(const Index& lambda,
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::a(const Index& la,
			     const Index& nu,
...
//            
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::f(const Index& lambda) const
    {
...
//                }
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    void
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::RHS(const double eta,
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::norm_A() const
    {
        if (normA == 0.0) {
...
//        cout << normA << ", " << normAinv << endl;
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::norm_Ainv() const
    {
        if (normAinv == 0.0) {
        typedef typename Frame::Index Index;
        typedef typename Index::polynomial_type polynomial_type;
...
//            cout << *it << endl;
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::s_star() const
    {
        // notation from [St04a]
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
        void
        SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>::compute_diagonal()
        {
          cout << " SlitDomainFrameGramian(): precompute diagonal of stiffness matrix..." << endl;
...
//      #endif
    ...
    template <class IFRAME, class SLITDOMAINFRAME>
    double
    SlitDomainFrameGramian<IFRAME, SLITDOMAINFRAME>:: integrate(const IndexQ1D<IFRAME>& la,
