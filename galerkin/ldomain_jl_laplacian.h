...
#ifndef _WAVELETTL_LDOMAIN_JL_LAPLACIAN_H
#define _WAVELETTL_LDOMAIN_JL_LAPLACIAN_H
...
{
  /*!
    wavelet-Galerkin discretization for the Laplacian with LDomainJLBasis.
  */
  class LDomainJLLaplacian
  ...
  public:
    ...
    */
    LDomainJLLaplacian(const WaveletBasis& basis,
...
#include <galerkin/ldomain_jl_laplacian.cpp>
