...
// Set macro PROJECTOR if projection strategy shall be used
#define PROJECTOR
#undef PROJECTOR

// Set macro SINGULARITY_RHS if singularity function is to be used for RHS
// somewhat lazy...
#define SINGULARITY_RHS
#undef SINGULARITY_RHS

// Set macro CONSTFUN if right-hand-side shall be a constant function
//#define CONSTFUN
