...
// implementation for slitdomain_frame_support.h
...
namespace WaveletTL
{
  ...
  bool intersect_supports(const SlitDomainFrame<IFRAME>& frame,
        ...
        typedef typename SlitDomainFrame<IFRAME>::Support Support;
...
//        const Support* supp_mu = &(frame.get_support(mu.number()));
        ...
        if (supp_la->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        
        if (supp_la->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_la->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_la->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        if (supp_mu->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        
        if (supp_mu->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        if (supp_la->xmin[0] == -1 && supp_mu->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        if (supp_la->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_mu->xmin[2] == -1 && supp_la->xmin[3] == -1) return false;
        if (supp_la->xmin[0] == -1 && supp_la->xmin[1] == -1 && supp_la->xmin[2] == -1 && supp_mu->xmin[3] == -1) return false;
  ...
  bool intersect_supports(const SlitDomainFrame<IFRAME>& frame,
			  const typename SlitDomainFrame<IFRAME>::Index& lambda,
			  const typename SlitDomainFrame<IFRAME>::Support& supp2,
			  typename SlitDomainFrame<IFRAME>::Support& supp)
  {
    typedef typename SlitDomainFrame<IFRAME>::Support Support;
...
//    frame.support(lambda, supp1);
    ...
    if (supp1.xmin[0] == -1 && supp2.xmin[1] == -1 && supp2.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp1.xmin[1] == -1 && supp2.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp2.xmin[1] == -1 && supp1.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp2.xmin[1] == -1 && supp2.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    
    if (supp1.xmin[0] == -1 && supp1.xmin[1] == -1 && supp2.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp1.xmin[0] == -1 && supp2.xmin[1] == -1 && supp1.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp1.xmin[0] == -1 && supp2.xmin[1] == -1 && supp2.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp1.xmin[1] == -1 && supp1.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp1.xmin[1] == -1 && supp2.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    if (supp2.xmin[0] == -1 && supp2.xmin[1] == -1 && supp1.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    
    if (supp2.xmin[0] == -1 && supp1.xmin[1] == -1 && supp1.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    if (supp1.xmin[0] == -1 && supp2.xmin[1] == -1 && supp1.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    if (supp1.xmin[0] == -1 && supp1.xmin[1] == -1 && supp2.xmin[2] == -1 && supp1.xmin[3] == -1) return false;
    if (supp1.xmin[0] == -1 && supp1.xmin[1] == -1 && supp1.xmin[2] == -1 && supp2.xmin[3] == -1) return false;
...
//    if (supp2.xmin[0] == -1 && supp1.xmin[1] == -1 && supp1.xmin[2] == -1) return false;
  ...
  inline
  bool intersect_supports(const SlitDomainFrame<IFRAME>& frame,
			  const typename SlitDomainFrame<IFRAME>::Index& lambda1,
			  const typename SlitDomainFrame<IFRAME>::Index& lambda2,
			  typename SlitDomainFrame<IFRAME>::Support& supp)
  {
    typedef typename SlitDomainFrame<IFRAME>::Support Support;
...
//    frame.support(lambda2, supp2);
  ...
  {
    typedef typename SlitDomainFrame<IFRAME>::Index Index;
    typedef typename SlitDomainFrame<IFRAME>::Support Support;
