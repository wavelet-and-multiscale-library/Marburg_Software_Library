...
#ifndef _WAVELETTL_PERIODIC_FRAME_GRAMIAN_H
#define _WAVELETTL_PERIODIC_FRAME_GRAMIAN_H
...
namespace WaveletTL
{
  ...
  */
  ...
  class PeriodicFrameIntervalGramian
  {
  public:
    /*!
      constructor from a given wavelet basis and a given right-hand side y
    */
    PeriodicFrameIntervalGramian(const PeriodicLaplacianProblem& plp, const PeriodicFrame<RFRAME>& frame);
...
#include <galerkin/periodic_frame_gramian.cpp>
