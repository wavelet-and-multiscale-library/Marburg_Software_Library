...
#ifndef _WAVELETTL_RECRING_FRAME_EQUATION_H
#define _WAVELETTL_RECRING_FRAME_EQUATION_H
...
namespace WaveletTL
{
  ...
  */
  ...
  template <class IFRAME,  class RECRINGFRAME = RecRingFrame<IFRAME> >
...
//     : public FullyDiagonalDyadicPreconditioner<typename RecRingBasis<IBASIS>::Index>
...
#endif
#ifdef TRIVIAL
    : public TrivialPreconditioner<typename RECRINGFRAME::Index>
#endif
#ifdef ENERGY
  ...
  public:
    ...
    */
    typedef RECRINGFRAME Frame;
//    typedef RecRingFrame<IFRAME> Frame;
    /*!
      constructor from a boundary value problem 
      not used anymore
    */
//    RecRingFrameEquation(const EllipticBVP<2>* bvp,
//		    const bool precompute_rhs = true);
    
    
    RecRingFrameEquation(const EllipticBVP<2>* bvp, const Frame* frame,
		    const bool precompute_rhs = true);
    /*!
    ...
    */
    ...
    /*!
      copy constructor
    */
    RecRingFrameEquation(const RecRingFrameEquation&);
...
#include <galerkin/recring_frame_equation.cpp>
