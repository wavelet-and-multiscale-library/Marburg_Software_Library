...
namespace WaveletTL
{
  ...
  inline
  double
  PeriodicIntervalLaplacian<RBASIS>::a(const typename WaveletBasis::Index& lambda,
  ...
  inline
  void
  PeriodicIntervalLaplacian<RBASIS>::RHS(const double eta,
  ...
  template <class RBASIS>
  void
  PeriodicIntervalLaplacian<RBASIS>::precompute_rhs() const
  {
  ...
  template <class RBASIS>
  double
  PeriodicIntervalLaplacian<RBASIS>::f(const Index& lambda) const
  {
