...
#ifndef _WAVELETTL_RECRING_FRAME_GRAMIAN_H
#define _WAVELETTL_RECRING_FRAME_GRAMIAN_H
...
namespace WaveletTL
{
  ...
  /*!
    ...
    when reformulating an poisson boundary value problem on the recring
...
//    typedef RecRingFrame<IFRAME> Frame;
    /*!
      ...
      not used anymore
    */
//    RecRingFrameGramian(const EllipticBVP<2>* bvp,
//		    const bool precompute_rhs = true);
    
    
    RecRingFrameGramian(const EllipticBVP<2>* bvp, const Frame* frame,
		    const bool precompute_rhs = true);
    /*!
    ...
    */
    ...
    /*!
      copy constructor
    */
    RecRingFrameGramian(const RecRingFrameGramian&);
...
#include <galerkin/recring_frame_gramian.cpp>
