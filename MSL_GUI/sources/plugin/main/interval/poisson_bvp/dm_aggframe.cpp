...
template <class IBASIS>
SimpleEllipticEquation<IBASIS,1>*
DM_AggFrame::Problem<IBASIS>::createDiscretizedEquation(const MathTL::PoissonBVP<1>& rawProblem,
                                                        const AggregatedFrame<IBASIS,1>& frame)
{
    return new SimpleEllipticEquation<IBASIS,1>(&rawProblem, &frame, this->lastInput_.jmax);
}
...
template class Instantiate<interval::poisson_bvp::DM_AggFrame>;
