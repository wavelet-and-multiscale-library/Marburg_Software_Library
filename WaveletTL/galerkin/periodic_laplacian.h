...
#ifndef _WAVELETTL_PERIODIC_LAPLACIAN_H
#define _WAVELETTL_PERIODIC_LAPLACIAN_H
...
namespace WaveletTL
{
  ...
  */
  ...
  class PeriodicIntervalLaplacian
  {
  public:
    /*!
      constructor from a given wavelet basis and a given right-hand side y
    */
    PeriodicIntervalLaplacian(const PeriodicLaplacianProblem& plp, const PeriodicBasis<RBASIS>& basis);
...
#include <galerkin/periodic_laplacian.cpp>
