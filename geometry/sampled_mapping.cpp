// implementation of SampledMapping inline functions
...
namespace MathTL
{
  ...
  void SampledMapping<1>::matlab_output(std::ostream& os) const
  {
  ...
  void SampledMapping<2>::matlab_output(std::ostream& os) const
  {
