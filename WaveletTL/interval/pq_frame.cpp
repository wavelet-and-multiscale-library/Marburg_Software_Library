  ...
  void PQFrame<d,dT>::setup_CVM() {
      ...
      if(s0==1 && s1==1){
            switch(d){
              case 3: switch(dT){
                            case 3: {
                                Matrix <double> tempmat(pmax, (dT+1)*(d+dT-2),
" 0.2025455652183159 -0.6548973275392216 0.6886549217422743 -0.2363031594213687 0.2236067977499787 -0.6708203932499367 0.6708203932499369 -0.223606797749979 0.2236067977499784 -0.6708203932499365 0.6708203932499374 -0.2236067977499794 -0.06398930756904883 0.1706381535174648 -0.7465419216389197 0.6398930756905037 "
