...
#ifndef _WAVELETTL_CACHED_QUARKLET_LDOMAIN_PROBLEM_H
#define	_WAVELETTL_CACHED_QUARKLET_LDOMAIN_PROBLEM_H
...
namespace WaveletTL
{
    ...
    public:
         ...
         * (if zero, CachedQuarkletLDomainProblem will compute the estimates)
         */
        CachedQuarkletLDomainProblem(PROBLEM* P,
...
#include "cached_quarklet_ldomain_problem.cpp"

#endif	/* _WAVELETTL__CACHED_QUARKLET_LDOMAINPROBLEM_H */
