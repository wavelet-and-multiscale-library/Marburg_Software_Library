...
// 	Mj1T_ = new QuasiStationaryMatrix<double>(j0_, 17, 8, Mj1T_l, Mj1T_r, Mj1T_band_lr, Mj1T_band_lr, 4, 4, 1.0);
      ...
      Mj0_(0), Mj1_(0), Mj0T_(0), Mj1T_(0)
  {
	...
	Vector<double> Mj0_band_lr(4, "0.176776695296637 0.530330085889911 0.530330085889911 0.17677669529663");
 	Mj0_ = new QuasiStationaryMatrix<double>(j0_, 30, 14, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 6, 6, 1.0);
 	entries.str("");
	...
	Vector<double> Mj0T_band_lr(8, entries.str().c_str());
 	Mj0T_ = new QuasiStationaryMatrix<double>(j0_, 30, 14, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 4, 4, 1.0);
 	entries.str("");
	...
	Vector<double> Mj1_band_r(8, entries.str().c_str());
 	Mj1_ = new QuasiStationaryMatrix<double>(j0_, 30, 16, Mj1_l, Mj1_r, Mj1_band_l, Mj1_band_r, 6, 6, 1.0);
 	entries.str("");
	entries << "-0.945626477541817 -2.23847517730569 -4.00109929078116 -3.25494089834593 "
 	...
 	Mj1T_ = new QuasiStationaryMatrix<double>(j0_,30, 16, Mj1T_l, Mj1T_r, Mj1T_band_l, Mj1T_band_r, 6, 6, 1.0);
      }
	...
	Matrix<double> Mj1T_l(10, 5, entries.str().c_str());
  	...
  	Vector<double> Mj1T_band_l(4, "-0.375 1.125 -1.125 0.375");
  	Vector<double> Mj1T_band_r(4, "0.375 -1.125 1.125 -0.375");
  	Mj1T_ = new QuasiStationaryMatrix<double>(j0_,30, 16, Mj1T_l, Mj1T_r, Mj1T_band_l, Mj1T_band_r, 8, 8, 1.0);
      }
    }
  }
