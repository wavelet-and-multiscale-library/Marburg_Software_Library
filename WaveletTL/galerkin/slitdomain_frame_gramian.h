...
#ifndef _WAVELETTL_SLITDOMAIN_FRAME_GRAMIAN_H
#define _WAVELETTL_SLITDOMAIN_FRAME_GRAMIAN_H
...
namespace WaveletTL
{
  ...
  /*!
    ...
    when reformulating an poisson boundary value problem on the slitdomain
...
//    typedef SlitDomainFrame<IFRAME> Frame;
    /*!
      ...
      not used anymore
    */
//    SlitDomainFrameGramian(const EllipticBVP<2>* bvp,
//		    const bool precompute_rhs = true);
    
    
    SlitDomainFrameGramian(const EllipticBVP<2>* bvp, const Frame* frame,
		    const bool precompute_rhs = true);
    /*!
    ...
    */
    ...
    /*!
      copy constructor
    */
    SlitDomainFrameGramian(const SlitDomainFrameGramian&);
...
#include <galerkin/slitdomain_frame_gramian.cpp>
