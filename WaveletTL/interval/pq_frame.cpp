  ...
  void PQFrame<d,dT>::setup_CVM() {
      ...
      if(s0==0 && s1==1){
            switch(d){
              case 3: switch(dT){
                      case 3: {
                          Matrix <double> tempmat(pmax, (dT+1)*(d+dT-2)," -0.8135849383260662 0.4881509629956393 -0.3037383769750648 0.08678239342144715   0.2025455652183159 -0.6548973275392216  0.6886549217422743 -0.2363031594213687  0.2236067977499784 -0.6708203932499365 0.6708203932499374 -0.2236067977499794  -0.06398930756904883  0.1706381535174648 -0.7465419216389197 0.6398930756905037  "
                                                                         " -0.804634462931811  0.4825884114596989 -0.3322361653395849 0.09638950475901535  -0.2631863804043411  0.683532627964419  -0.647689149490306   0.2097971432366053  0.2236067977499784 -0.6708203932499365 0.6708203932499374 -0.2236067977499794 0.05359750604883835 -0.1585898809126361 -0.6145357885456364 0.7709230322243936 "
                                                                         " -0.8292748489821371 0.4470873098860249 -0.3214083886738285 0.09546103851637334   0.2167794512514804 -0.6656161436521536  0.6767648011450804 -0.2279281087444072  0.2236067977369626 -0.6708203932369206 0.6708203932629532 -0.2236067977629952 0.07505866259329713 -0.4503519751849037 -0.4128226436599776 0.788115956251584 "
                                                                         " -0.8111748791095182 0.4568712663959324 -0.34939052424605   0.1057838504238986   -0.2337005659921087  0.6749399235427884 -0.6645436634817194  0.2195947731375184 -0.2236067987706151 0.6708203942185108 -0.6708203922553321 0.2236067968074362  0.1040966707159132  -0.5950659374191536 -0.2527858014715041 0.755751117659601 "
                                                                         " -0.810199380138568  0.452767950065765  -0.355958929372318  0.1089559012465069    0.2215835947572188 -0.6692635936886583  0.6726040031334517 -0.2249240042020122  0.2236068066976706 -0.6708204020865624 0.6708203843577781 -0.2236067889688864  0.07299534619159279 -0.6558770463101348 -0.1527558639038796 0.7356375640224215 "
                                                                         " -0.7965210936116699 0.4602213845988072 -0.3745463076927572 0.1160408892733443   -0.2262823111496524  0.6720199792759201 -0.6690975041966392  0.222472454458058   -0.2236069275296845 0.670820516703335 -0.6708202665819002 0.2236066776140496  0.05914854058002748 -0.6920237805634262 -0.07937587026932126 0.7150552485654124 ");
                          //cout << "setup: " << endl << tempmat << endl;
                          CVM = tempmat;
                      }
                      }
