...
namespace WaveletTL
{
    ...
    template <int d, int dT>
    void 
    PBasis<d,dT>::setup_additional_duals_L(Matrix<double>& MLTp) {
    ...
    template <int d, int dT>
    void 
    PBasis<d,dT>::setup_additional_duals_R(Matrix<double>& MRTp) {
        // setup gramian matrix from [P], Remark 4.2 using [P], Section 2.5
...
//   }
    ...
    inline
    void
    PBasis<d,dT>::evaluate(const unsigned int derivative,
            const Index& lambda,
