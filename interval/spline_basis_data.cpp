...
namespace WaveletTL
{
      ...
      s0_(s0), s1_(s1), sT0_(sT0), sT1_(sT1)
  {
    ...
    if (s0==0 && s1==0) { // no Dirichlet b.c.'s
      ...
      Mj0_ = QuasiStationaryMatrix<double>(j0_, 9, 5, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 1, 1, M_SQRT1_2);
      ...
      Mj0T_ = QuasiStationaryMatrix<double>(j0_, 9, 5, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 2, 2, M_SQRT1_2);
      ...
      Mj1_ = QuasiStationaryMatrix<double>(j0_, 9, 4, Mj1_l, Mj1_r, Mj1_band_lr, Mj1_band_lr, 1, 1, M_SQRT1_2);
      Matrix<double> Mj1T_lr(0); // empty corner blocks
      Vector<double> Mj1T_band_lr(3, "-1 2 -1");
      Mj1T_ = QuasiStationaryMatrix<double>(j0_, 9, 4, Mj1T_lr, Mj1T_lr, Mj1T_band_lr, Mj1T_band_lr, 0, 0, M_SQRT1_2);
    }
    ...
    if (s0==1 && s1==0) { // homogeneous Dirichlet b.c.'s at x=0
      ...
      Vector<double> Mj0_band_lr(3, "0.5 1.0 0.5");
      Mj0_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 0, 1, M_SQRT1_2);
      ...
      Vector<double> Mj0T_band_lr(5, "-0.25 0.5 1.5 0.5 -0.25");
      Mj0T_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 3, 2, M_SQRT1_2);
      Matrix<double> Mj1_l(5, 1, "0.625 -0.75 -0.25 0.25 0.125");
      Matrix<double> Mj1_r(4, 1, "-0.0625 -0.125 0.5625 -0.75");
      Vector<double> Mj1_band_lr(5, "-0.125 -0.25 0.75 -0.25 -0.125");
      Mj1_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj1_l, Mj1_r, Mj1_band_lr, Mj1_band_lr, 0, 1, M_SQRT1_2);
      Matrix<double> Mj1T_l(2, 1, "2 -1");
      Matrix<double> Mj1T_r(0); // empty corner block
      Vector<double> Mj1T_band_lr(3, "-1 2 -1");
      Mj1T_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj1T_l, Mj1T_r, Mj1T_band_lr, Mj1T_band_lr, 1, 0, M_SQRT1_2);
    }
    ...
    if (s0==0 && s1==1) { // homogeneous Dirichlet b.c.'s at x=1
      ...
      Vector<double> Mj0_band_lr(3, "0.5 1.0 0.5");
      Mj0_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 1, 0, M_SQRT1_2);
      Matrix<double> Mj0T_l(5, 2, "1.25 -0.125 1.5 0.25 -0.75 1.625 0 0.5 0 -0.25");
      Matrix<double> Mj0T_r(6, 2, "-0.25 0 0.5 0 1.5 -0.25 0.5 0.5 0 1 -0.5 1.5");
      Vector<double> Mj0T_band_lr(5, "-0.25 0.5 1.5 0.5 -0.25");
      Mj0T_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 2, 3, M_SQRT1_2);
      Matrix<double> Mj1_l(4, 1, "-0.75 0.5625 -0.125 -0.0625");
      Matrix<double> Mj1_r(5, 1, "0.125 0.25 -0.25 -0.75 0.625");
      Vector<double> Mj1_band_lr(5, "-0.125 -0.25 0.75 -0.25 -0.125");
      Mj1_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj1_l, Mj1_r, Mj1_band_lr, Mj1_band_lr, 1, 0, M_SQRT1_2);
      Matrix<double> Mj1T_l(0); // empty corner block
      Matrix<double> Mj1T_r(2, 1, "-1 2");
      Vector<double> Mj1T_band_lr(3, "-1 2 -1");
      Mj1T_ = QuasiStationaryMatrix<double>(j0_, 8, 4, Mj1T_l, Mj1T_r, Mj1T_band_lr, Mj1T_band_lr, 0, 1, M_SQRT1_2);
    }
    ...
    if (s0==1 && s1==1) { // homogeneous Dirichlet b.c.'s at x=0 and x=1
      ...
      Vector<double> Mj0_band_lr(3, "0.5 1.0 0.5");
      Mj0_ = QuasiStationaryMatrix<double>(j0_, 15, 7, Mj0_lr, Mj0_lr, Mj0_band_lr, Mj0_band_lr, 0, 0, M_SQRT1_2);
      Matrix<double> Mj0T_l(6, 2, "1.5 -0.5 1 0 0.5 0.5 -0.25 1.5 0 0.5 0 -0.25");
      Matrix<double> Mj0T_r; Mj0T_l.mirror(Mj0T_r);
      Vector<double> Mj0T_band_lr(5, "-0.25 0.5 1.5 0.5 -0.25");
      Mj0T_ = QuasiStationaryMatrix<double>(j0_, 15, 7, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 3, 3, M_SQRT1_2);
      Matrix<double> Mj1_l(5, 1, "0.625 -0.75 -0.25 0.25 0.125");
      Matrix<double> Mj1_r; Mj1_l.mirror(Mj1_r);
      Vector<double> Mj1_band_lr(5, "-0.125 -0.25 0.75 -0.25 -0.125");
      Mj1_ = QuasiStationaryMatrix<double>(j0_, 15, 8, Mj1_l, Mj1_r, Mj1_band_lr, Mj1_band_lr, 0, 0, M_SQRT1_2);
      Matrix<double> Mj1T_l(2, 1, "2 -1");
      Matrix<double> Mj1T_r; Mj1T_l.mirror(Mj1T_r);
      Vector<double> Mj1T_band_lr(3, "-1 2 -1");
      Mj1T_ = QuasiStationaryMatrix<double>(j0_, 15, 8, Mj1T_l, Mj1T_r, Mj1T_band_lr, Mj1T_band_lr, 1, 1, M_SQRT1_2);
    }
  }
      ...
      s0_(s0), s1_(s1), sT0_(sT0), sT1_(sT1)
  {
    ...
    if (s0==1 && s1==1) { // homogeneous Dirichlet b.c.'s at x=0 and x=1
      ...
      Mj0_ = QuasiStationaryMatrix<double>(j0_, 16, 8, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 1, 1, M_SQRT1_2);
      ...
      Mj0T_ = QuasiStationaryMatrix<double>(j0_, 16, 8, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 3, 3, M_SQRT1_2);
      entries.str("");
      ...
      Mj1_ = QuasiStationaryMatrix<double>(j0_, 16, 8, Mj1_l, Mj1_r, Mj1_band_l, Mj1_band_r, 1, 1, M_SQRT1_2);
      ...
      Mj1T_ = QuasiStationaryMatrix<double>(j0_, 16, 8, Mj1T_l, Mj1T_r, Mj1T_band_l, Mj1T_band_r, 1, 1, M_SQRT1_2);
    }
  }
...
// 	Mj1c_ = QuasiStationaryMatrix<double>(j0_, 9, 4, Mj1c_l, Mj1c_r, Mj1_band_lr, Mj1_band_lr, 3, 3, 1.0);
      ...
      s0_(s0), s1_(s1), sT0_(sT0), sT1_(sT1)
  {
	...
	Vector<double> Mj0_band_lr(4, "0.176776695296637 0.530330085889911 0.530330085889911 0.17677669529663");
 	Mj0_ = QuasiStationaryMatrix<double>(j0_, 30, 14, Mj0_l, Mj0_r, Mj0_band_lr, Mj0_band_lr, 6, 6, 1.0);
 	entries.str("");
	...
	Vector<double> Mj0T_band_lr(8, entries.str().c_str());
 	Mj0T_ = QuasiStationaryMatrix<double>(j0_, 30, 14, Mj0T_l, Mj0T_r, Mj0T_band_lr, Mj0T_band_lr, 4, 4, 1.0);
 	entries.str("");
	...
	Vector<double> Mj1_band_r(8, entries.str().c_str());
 	Mj1_ = QuasiStationaryMatrix<double>(j0_, 30, 16, Mj1_l, Mj1_r, Mj1_band_l, Mj1_band_r, 6, 6, 1.0);
 	entries.str("");
	entries << "-0.945626477541817 -2.23847517730569 -4.00109929078116 -3.25494089834593 "
 	...
 	Mj1T_ = QuasiStationaryMatrix<double>(j0_,30, 16, Mj1T_l, Mj1T_r, Mj1T_band_l, Mj1T_band_r, 6, 6, 1.0);
	entries.str("");
	entries << "0 0 0 0 0 "
		<< "-0.253882978723144 -0.215443816489063 0.211384640957205 0.262185837765684 0.0349335106382616 "
		...
		<< "0 0 0 0 0.09375 "
		<< "0 0 0 0 0.03125";
  	Matrix<double> Mj1c_l(12, 5, entries.str().c_str());
 	Matrix<double> Mj1c_r; Mj1c_l.mirror(Mj1c_r);
 	Mj1c_ = QuasiStationaryMatrix<double>(j0_, 30, 16, Mj1c_l, Mj1c_r, Mj1_band_l, Mj1_band_r, 6, 6, 1.0);
	entries.str("");
	...
	Matrix<double> Mj1T_l(10, 5, entries.str().c_str());
  	...
  	Vector<double> Mj1T_band_l(4, "-0.375 1.125 -1.125 0.375");
  	Vector<double> Mj1T_band_r(4, "0.375 -1.125 1.125 -0.375");
  	Mj1T_ = QuasiStationaryMatrix<double>(j0_,30, 16, Mj1T_l, Mj1T_r, Mj1T_band_l, Mj1T_band_r, 8, 8, 1.0);
	entries.str("");
	entries << "0 0 0 0 0 "
		<< "-0.253882978723144 0.000413971951306335 -0.00954618200058477 -0.000555658994278584 -0.029015938902841 "
  ...
  SplineBasisData<d,dT,DS_construction>::~SplineBasisData()
  {
  }
  ...
  template <int d,int dT>
  void
  SplineBasisData<d,dT,DS_construction>::check() const
  {
    cout << endl
	 << "-------------------------------" << endl
	 << "SplineBasisData::check() called" << endl
    ...
    cout << "* some basic data:" << endl;
    cout << "  flavor: " << DS_construction << endl;
    cout << "  options: " << options_ << endl;
    cout << "  d=" << d << endl;
    cout << "  dT=" << dT << endl;
    cout << "  s0=" << s0_ << endl;
