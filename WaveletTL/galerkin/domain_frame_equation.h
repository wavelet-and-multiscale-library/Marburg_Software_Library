...
#ifndef _WAVELETTL_DOMAIN_FRAME_EQUATION_H
#define _WAVELETTL_DOMAIN_FRAME_EQUATION_H
...
namespace WaveletTL
{
  template <class IFRAME, int NPATCHES> class DomainFrame;  //nötig?
  ...
  */
  ...
  template <class IFRAME,  int NPATCHES, class DOMAINFRAME = DomainFrame<IFRAME, NPATCHES> >
  class DomainFrameEquation
//     : public FullyDiagonalDyadicPreconditioner<typename DomainBasis<IBASIS>::Index>
#ifdef DYADIC  
  : public FullyDiagonalQuarkletPreconditioner<typename DOMAINFRAME::Index, 2>

    
#endif
#ifdef TRIVIAL
    : public TrivialPreconditioner<typename DOMAINFRAME::Index>
#endif
#ifdef ENERGY
    : public FullyDiagonalEnergyNormPreconditioner<typename DOMAINFRAME::Index>
#endif
#ifdef DYPLUSEN
    : public FullyDiagonalDyPlusEnNormPreconditioner<typename DOMAINFRAME::Index, 2>
#endif
  ...
  public:
    ...
    */
    typedef DOMAINFRAME Frame;
//    typedef DomainFrame<IFRAME> Frame;
    /*!
      constructor from a boundary value problem 
      not used anymore
    */
//    DomainFrameEquation(const EllipticBVP<2>* bvp,
//		    const bool precompute_rhs = true);
    
    
    DomainFrameEquation(const EllipticBVP<2>* bvp, const Frame* frame,
		    const bool precompute_rhs = true);
    /*!
    ...
    */
    ...
    /*!
      copy constructor
    */
    DomainFrameEquation(const DomainFrameEquation&);
...
#include <galerkin/domain_frame_equation.cpp>
